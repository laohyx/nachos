...
//              -z -K -C -N
//              -mem <numberofpages> -tlb <numberofpages>
//
//    -mem change number of physical memory pages. default is set in kernel.cc (32)
//    -tlb change TLB size. default is set in kernel.cc (4)
